...
export default function Layout({ children }) {
  ...
  const [darkMode, setDarkMode] = React.useState(isUndefined(darkmode) ? false
     : darkmode)
  ...
  return (
    <AudioContext.Provider value={{audioSource, setAudioSource, audioTitle, setAudioTitle, audioImage, setAudioImage, radioMode, setRadioMode}}>
